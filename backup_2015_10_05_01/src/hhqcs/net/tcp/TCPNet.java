...
public class TCPNet {
    ...
    public TCPNet(int port, InetAddress ipAddress) throws IOException {
        ...
        initialisation(port, ipAddress);
    }

    private void initialisation(int port1, InetAddress ipAddress1) throws SocketException, IOException {
        /*
    ...
    public TCPNet(int port, InetAddress ipAddress, long clientRestartTime) throws IOException {
