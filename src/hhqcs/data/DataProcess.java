...
import hhqcs.tools.ByteArrayConcat;
    ...
    public void process(TCPConnectionServer tcp) {
        ...
        if (tcp.receiveTelegram.length == TELEGRAMLENGTH) {
            if (tempReceiveTelegramm != null) {
                ...
                HHQCS.debug.printDebugMsg(tcp.setup.PLANTNAME, DataProcess.class.getName(),
                        "(tempReceiveTelegramm!=null): Az eldobandó byte tartalma:",
                        Arrays.toString(tempReceiveTelegramm));
            ...
            HHQCS.debug.printDebugMsg(tcp.setup.PLANTNAME, DataProcess.class.getName(),
                    "A telegram hossza nem megfelelő: (" + tcp.receiveTelegram.length + ")");
            /**
        ...
        if (tcp.receiveTelegram.length == TELEGRAMLENGTH) {
            ...
            if (messageId > 0 && messageId != MESSAGENUMBERS && tcp.th.MessageId == 1) {
                ...
                HHQCS.debug.printDebugMsg(tcp.setup.PLANTNAME, DataProcess.class.getName(),
                        "Hiba az üzenet azonositónál: (" + messageId + " : " + tcp.th.MessageId + ")");
                ...
                if (collectedReceiveTelegram != null) {
                    ...
                    HHQCS.debug.printDebugMsg(tcp.setup.PLANTNAME, DataProcess.class.getName(),
                            "Az eldobandó byte tartalma:", Arrays.toString(collectedReceiveTelegram));
                }
            }
            ...
            if ((((messageId + 1) == tcp.th.MessageId) && (tcp.th.CoilGeneratedId == coilGeneratedId))
                ...
                try {
                    ...
                    HHQCS.debug.printDebugMsg(tcp.setup.PLANTNAME, DataProcess.class.getName(),
                            " " + tcp.ch.coilID + " " + tcp.th.CoilGeneratedId
                            + " tekercshez részüzenet érkezett (" + tcp.th.MessageId + ")");
                } catch (Exception ex) {
                    System.out.println(new Date().toString() + " "
                ...
                if (tcp.th.MessageId == MESSAGENUMBERS) {
                    ...
                    if (dataLength % ONEDATALENGTH == 0 && dataLength >= 0) {
                        ...
                        HHQCS.debug.printDebugMsg(tcp.setup.PLANTNAME, DataProcess.class.getName(), "Az üzenet hossza nem megfelelő",
                ...
                HHQCS.debug.printDebugMsg(tcp.setup.PLANTNAME, DataProcess.class.getName(),
                        "Telegram üzenetazonosítója, vagy a tekercs azomnosítója nem megfelelő: "
                        + "(" + messageId + " : " + tcp.th.MessageId + ")");
            }
        }
    }
